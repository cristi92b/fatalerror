...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(UsernameTextBox);
        UsernameTextBox.getAccessibleContext().setAccessibleName("");

        jScrollPane2.setViewportView(PasswordTextBox);
        PasswordTextBox.getAccessibleContext().setAccessibleName("");
        PasswordTextBox.getAccessibleContext().setAccessibleDescription("Username TextBox");
